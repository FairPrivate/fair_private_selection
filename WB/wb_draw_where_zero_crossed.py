...
epsilons15[0] = 0.0001
#data15_1 = pd.read_csv('wb_accuracy_in_all_iterations_debiased_1_4_10000_2Kepsilon_rho_sensitivity_comp_9.csv')
data15_1 = pd.read_csv('wb_accuracy_in_all_iterations_debiased_wb_debiased_eo_3_1_250.csv')
...
z15_1 = np.polyfit(epsilons15, data15_1, 9)
...
legend1 = ax.legend(*scatter.legend_elements(num = None),
                    ...
                    prop={'size': 12}, ncol=5, fancybox=True, shadow=True, loc="lower right", title=r"$\alpha$ values")
ax.add_artist(legend1)
ax.legend()
plt.savefig('fz_wb_all_legend_2.pdf')
#plt.show()
