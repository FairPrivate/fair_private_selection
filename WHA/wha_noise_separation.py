...
P00 = pd.read_csv('P00_wha.csv', header=None)
P01 = pd.read_csv('P01_wha.csv', header=None)
P10 = pd.read_csv('P10_wha.csv', header=None)
P11 = pd.read_csv('P11_wha.csv', header=None)
...
epsilons1 = [0.017*x for x in range(3000)]
epsilons1[0] = 0.0001

epsilons2 = [0.01*x for x in range(3000)]
epsilons2[0] = 0.0001
...
prob_a.to_csv('wha_17_1_1_prob_a.csv')
prob_b.to_csv('wha_17_1_1_prob_b.csv')
equal_opportunity.to_csv('wha_17_1_1_equal_opportunity.csv')
accuracy_in_all.to_csv('wha_17_1_1_accuracy_in_all.csv')
accuracy_in_a.to_csv('wha_17_1_1_accuracy_in_a.csv')
accuracy_in_b.to_csv('wha_17_1_1_accuracy_in_b.csv')
accuracy_in_all_iterations.to_csv('wha_17_1_1_accuracy_in_all_iterations.csv')
accuracy_in_a_iterations.to_csv('wha_17_1_1_accuracy_in_a_iterations.csv')
accuracy_in_b_iterations.to_csv('wha_17_1_1_accuracy_in_b_iterations.csv')
