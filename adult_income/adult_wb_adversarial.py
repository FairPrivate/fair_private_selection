...
df_w = test[test['race'] == 1]  # 38903   # 19477
df_b = test[test['race'] == 0]  # 4228    # 2089

df_w_0 = df_w[df_w['label'] == 0]  # 28696    # 14371
df_w_1 = df_w[df_w['label'] == 1]  # 10207    # 5105

df_b_0 = df_b[df_b['label'] == 0]  # 3694     # 1839
df_b_1 = df_b[df_b['label'] == 1]  # 534      # 250
...
batch_size = 5
model_name = 'adult_debiased_eo_'+str(num_epochs)+"_"+str(adversary_loss_weight)+"_"+str(batch_size)+""
...
#                          scope_name='debiased_classifier', debias=True, sess=sess, num_epochs=100, batch_size=20,
...
accuracy_original = (sum(without_noise_True_a_iteration_original) + sum(without_noise_True_b_iteration_original)) / float(qualified_a_population + qualified_b_population)
accuracy_all_in_ite_original = (sum(without_noise_True_a_iteration_original) + sum(without_noise_True_b_iteration_original)) / float(number_of_iterations)
...
df.to_csv('adult_wb_without_noise_debiased_vs_original_multiple_selection_'+str(model_name)+'.csv')
print('hi')
...
#accuracy_in_all_original_1 = (agg_True_a_iteration_1_original_df + agg_True_b_iteration_1_original_df).div(qualified_a_population + qualified_b_population)
accuracy_in_all_iterations_original_1 = (agg_True_a_iteration_1_original_df + agg_True_b_iteration_1_original_df).div(number_of_iterations)
...
#prob_a_original_1.to_csv('adult_wb_prob_a_original_multiple_selection_1.csv')
#prob_b_original_1.to_csv('adult_wb_prob_b_original_multiple_selection_1.csv')
equal_opportunity_original_1.to_csv('adult_wb_equal_opportunity_original_multiple_selection_1_'+str(model_name)+'.csv')
#accuracy_in_all_original_1.to_csv('adult_wb_accuracy_in_all_original_multiple_selection_1.csv')
accuracy_in_all_iterations_original_1.to_csv('adult_wb_accuracy_in_all_iterations_original_multiple_selection_1_'+str(model_name)+'.csv')
#accuracy_in_a_iterations_original_1.to_csv('adult_wb_accuracy_in_a_iterations_original_multiple_selection_1.csv')
#accuracy_in_b_iterations_original_1.to_csv('adult_wb_accuracy_in_b_iterations_original_multiple_selection_1.csv')
...
prob_a_original_2.to_csv('adult_wb_prob_a_original_multiple_selection_2.csv')
prob_b_original_2.to_csv('adult_wb_prob_b_original_multiple_selection_2.csv')
equal_opportunity_original_2.to_csv('adult_wb_equal_opportunity_original_multiple_selection_2.csv')
accuracy_in_all_original_2.to_csv('adult_wb_accuracy_in_all_original_multiple_selection_2.csv')
accuracy_in_all_iterations_original_2.to_csv(
    'adult_wb_accuracy_in_all_iterations_original_multiple_selection_2.csv')
accuracy_in_a_iterations_original_2.to_csv(
    'adult_wb_accuracy_in_a_iterations_original_multiple_selection_2.csv')
accuracy_in_b_iterations_original_2.to_csv(
    'adult_wb_accuracy_in_b_iterations_original_multiple_selection_2.csv')
...
prob_a_original_3.to_csv('adult_wb_prob_a_original_multiple_selection_3.csv')
prob_b_original_3.to_csv('adult_wb_prob_b_original_multiple_selection_3.csv')
equal_opportunity_original_3.to_csv('adult_wb_equal_opportunity_original_multiple_selection_3.csv')
accuracy_in_all_original_3.to_csv('adult_wb_accuracy_in_all_original_multiple_selection_3.csv')
accuracy_in_all_iterations_original_3.to_csv(
    'adult_wb_accuracy_in_all_iterations_original_multiple_selection_3.csv')
accuracy_in_a_iterations_original_3.to_csv(
    'adult_wb_accuracy_in_a_iterations_original_multiple_selection_3.csv')
accuracy_in_b_iterations_original_3.to_csv(
    'adult_wb_accuracy_in_b_iterations_original_multiple_selection_3.csv')
...
prob_a_original_4.to_csv('adult_wb_prob_a_original_multiple_selection_4.csv')
prob_b_original_4.to_csv('adult_wb_prob_b_original_multiple_selection_4.csv')
equal_opportunity_original_4.to_csv('adult_wb_equal_opportunity_original_multiple_selection_4.csv')
accuracy_in_all_original_4.to_csv('adult_wb_accuracy_in_all_original_multiple_selection_4.csv')
accuracy_in_all_iterations_original_4.to_csv(
    'adult_wb_accuracy_in_all_iterations_original_multiple_selection_4.csv')
accuracy_in_a_iterations_original_4.to_csv(
    'adult_wb_accuracy_in_a_iterations_original_multiple_selection_4.csv')
accuracy_in_b_iterations_original_4.to_csv(
    'adult_wb_accuracy_in_b_iterations_original_multiple_selection_4.csv')
...
#prob_a_1.to_csv('adult_wb_prob_a_debiased_multiple_selection_1.csv')
#prob_b_1.to_csv('adult_wb_prob_b_debiased_multiple_selection_1.csv')
equal_opportunity_1.to_csv('adult_wb_equal_opportunity_debiased_multiple_selection_1_'+str(model_name)+'.csv')
#accuracy_in_all_1.to_csv('adult_wb_accuracy_debiased_multiple_selection_1.csv')
accuracy_in_all_iterations_1.to_csv('adult_wb_accuracy_in_all_iterations_debiased_multiple_selection_1_'+str(model_name)+'.csv')
#accuracy_in_a_iterations_1.to_csv('adult_wb_accuracy_in_a_iterations_debiased_multiple_selection_1.csv')
#accuracy_in_b_iterations_1.to_csv('adult_wb_accuracy_in_b_iterations_debiased_multiple_selection_1.csv')
...
prob_a_2.to_csv('adult_wb_prob_a_debiased_multiple_selection_2.csv')
prob_b_2.to_csv('adult_wb_prob_b_debiased__multiple_selection_2.csv')
equal_opportunity_2.to_csv('adult_wb_equal_opportunity_debiased_multiple_selection_2.csv')
accuracy_in_all_2.to_csv('adult_wb_accuracy_debiased_multiple_selection_2.csv')
accuracy_in_all_iterations_2.to_csv(
    'adult_wb_accuracy_in_all_iterations_debiased_multiple_selection_2.csv')
accuracy_in_a_iterations_2.to_csv(
    'adult_wb_accuracy_in_a_iterations_debiased_multiple_selection_2.csv')
accuracy_in_b_iterations_2.to_csv(
    'adult_wb_accuracy_in_b_iterations_debiased_multiple_selection_2.csv')
...
prob_a_3.to_csv('adult_wb_prob_a_debiased_multiple_selection_3.csv')
prob_b_3.to_csv('adult_wb_prob_b_debiased__multiple_selection_3.csv')
equal_opportunity_3.to_csv('adult_wb_equal_opportunity_debiased_multiple_selection_3.csv')
accuracy_in_all_3.to_csv('adult_wb_accuracy_debiased_multiple_selection_3.csv')
accuracy_in_all_iterations_3.to_csv(
    'adult_wb_accuracy_in_all_iterations_debiased_multiple_selection_3.csv')
accuracy_in_a_iterations_3.to_csv(
    'adult_wb_accuracy_in_a_iterations_debiased_multiple_selection_3.csv')
accuracy_in_b_iterations_3.to_csv(
    'adult_wb_accuracy_in_b_iterations_debiased_multiple_selection_3.csv')
...
prob_a_4.to_csv('adult_wb_prob_a_debiased_multiple_selection_4.csv')
prob_b_4.to_csv('adult_wb_prob_b_debiased__multiple_selection_4.csv')
equal_opportunity_4.to_csv('adult_wb_equal_opportunity_debiased_multiple_selection_4.csv')
accuracy_in_all_4.to_csv('adult_wb_accuracy_debiased_multiple_selection_4.csv')
accuracy_in_all_iterations_4.to_csv(
    'adult_wb_accuracy_in_all_iterations_debiased_multiple_selection_4.csv')
accuracy_in_a_iterations_4.to_csv(
    'adult_wb_accuracy_in_a_iterations_debiased_multiple_selection_4.csv')
accuracy_in_b_iterations_4.to_csv(
    'adult_wb_accuracy_in_b_iterations_debiased_multiple_selection_4.csv')
'''